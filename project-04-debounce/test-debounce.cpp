...
TEST_CASE_METHOD(Fixture, "[debounce] Switch down", "[project-04]")
{
...
TEST_CASE_METHOD(Fixture, "[debounce] Switch down then up before timeout", "[project-04]")
{
...
TEST_CASE_METHOD(Fixture, "[debounce] Switch down then up just before timeout", "[project-04]")
{
...
TEST_CASE_METHOD(Fixture, "[debounce] Switch down then up just after timeout", "[project-04]")
{
